...
if (!function_exists('b_waiting_mxdirectory_base')) {
    ...
    function b_waiting_mxdirectory_base($mydirname)
    {
        ...
        if ($result) {
            ...
            $block[] = array(
                'adminlink'     => XOOPS_URL . '/modules/' . $mydirname . '/admin/main.php?op=listNewLinks',
                'pendingnum'    => $cnt,
        ...
        if ($result) {
            ...
            list($cnt) = $xoopsDB->fetchRow($result);
            $block[] = array(
                'adminlink'     => XOOPS_URL . '/modules/' . $mydirname . '/admin/main.php?op=listModReq',
                'pendingnum'    => $cnt,
        ...
        if ($result) {
            list($cnt) = $xoopsDB->fetchRow($result);
            $block[] = array(
                'adminlink'     => XOOPS_URL . '/modules/' . $mydirname . '/admin/main.php?op=listBrokenLinks',
                'pendingnum'    => $cnt,
